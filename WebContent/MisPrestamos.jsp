<%@page import="com.sun.corba.se.spi.presentation.rmi.PresentationManager"%>
...
<nav class="navbar navbar-expand-large navbar-light"
	...
	<div class="container">
		<div class="row mt-2">
			<div class="col-md-12">
				<h3 class="display-4 text-info">Mis prestamos</h3>
			</div>
		</div>
		...
		<div class="col-md-1">
				<input type="text" class="form-control" name="TXTmontoMensual"
								id="Montomens"  value="<%=request.getAttribute("pendientes")%>" readonly>
		</div>				
