...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav">
			...
			<div class="col-md-2">
						<li class="nav-item active"><a class="nav-link" href="HomeAdmin.jsp">Home
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu"
							...
							<a class="dropdown-item" href="NuevaCuenta.jsp">Nueva cuenta</a> <a
								class="dropdown-item" href="ListadoCuentas.jsp">Modificar cuenta</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="ListadoCuentas.jsp">Eliminar cuenta</a>
						</div></li>
				</div>
				<div class="col-md-3">
