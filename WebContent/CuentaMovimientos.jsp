                  ...
                  <div class="row">
                        <div class="col-md-2">
                              <li class="nav-item active"><a
                                    class="nav-link"
                                    href="IndexUsuario.jsp">Home <span
            ...
            <div class="row mt-2 d-flex justify-content-center"
                  ...
                  <div class="col-md-8" style="">
                        <form action="ServletCliente" method="get">
                              <label for="">Seleccione una
                                    cuenta</label> <select class="form-control"
                                    id="selectCuenta" name="TXTcbu">
                                    <%
                              ...
                              <div class="container-fluid">
                                    ...
                                    <div
                                          ...
                                          <div
                                                ...
                                                <input type="submit"
                                                      name="BtnVerMovimientos"
                                                      value="ver Movimientos">
                                                <input type="submit"
                                                      name="BtnCargaTransferencia"
                                          ...
                                          <div
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <input
                                                            ...
                                                            name="TXTsaldo"
                                                            id="saldo"
                                                            value="<%=request.getAttribute("saldo")%>"
                                                            disabled />
                                                </div>
