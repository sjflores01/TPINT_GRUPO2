...
<body>
	<nav class="navbar navbar-expand-large navbar-light"
		...
		<a class="navbar-brand" href="#">BANCO JAVA ADMIN</a>
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
				<div class="row">
					...
					<div class="col-md-3">
						<li class="nav-item"><a class="nav-link" href="#">Solicitudes de prestamos</a>
						</li>
					</div>
					<div class="col-md-2">
	...
	<div class="container">
		...
		<div class="row mt-2 d-flex justify-content-center" style="position:relative; top:50px">
