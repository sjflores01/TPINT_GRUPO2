					...
					<div class="container-fluid">
						<div class="row d-flex justify-content-center">
							<div class="col-6">
								...
								<label for="fondos">Fondos disponibles:</label> <input
									type="text" class="form-control" name="TXTfondos" id="fondos"
						...
						<div class="row d-flex justify-content-center">
							<div class="col-6">
								...
								<label for="fondos">Fondos disponibles:</label> <input
									type="text" class="form-control" name="TXTcbu" id="fondos"
									aria-describedby="emailHelp" placeholder="cbu destino" required>
							</div>
						</div>
						<div class="row d-flex justify-content-center">
							<div class="col-6">
								...
								<label for="fondos">Fondos disponibles:</label> <input
									type="number" class="form-control" name="TXTmonto" id="fondos"
									aria-describedby="emailHelp" placeholder="monto" required>
							</div>
						</div>
						<div class="row d-flex justify-content-center">
							<div class="col-6">
