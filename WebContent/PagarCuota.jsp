...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<%
			...
			Prestamo pres = (Prestamo) request.getAttribute("prestamo");
		...
		<ul class="navbar-nav">
			<div class="row">
				...
				<div class="col-md-2">
					<li class="nav-item active"><a class="nav-link"
						href="ServletCliente?Logout=1">Salir <span class="sr-only">(current)</span>
					</a></li>
				</div>
	...
	<div class="container">
		<div class="row mt-2">
			<div class="col-md-12">
				<h3 class="display-4 text-info">Pagar cuota</h3>
			</div>
		</div>
		<form action="ServletCliente" method="get">
			...
			<div class="row mt-2 d-flex justify-content-center"
				...
				<div class="col-md-4">
					...
					<label for="">Valor a pagar</label> <input type="text"
						class="form-control" name="TXTmontoMensual" id="Montomens"
						value="<%=pres.getMontoMensual()%>" readonly>
			...
			<div class="row mt-2 d-flex justify-content-center"
				...
				<div class="col-md-4 d-flex justify-content-center">
					...
					<input type="submit" name="BtnPagarCuota" value="Pagar"> <input
						type="hidden" name="TXTidPrestamo" value="<%=pres.getId()%>" />
...
<%if(request.getAttribute("mensaje") != null) {
		...
		<div class="row mt-2 d-flex justify-content-center" style="position:relative; top:80px">
