            ...
            <ul class="navbar-nav">
                  <div class="row">
                        ...
                        <div class="col-md-2">
                              ...
                              <a class="dropdown-item"
                                    href="ServletCuenta?ListaCuentas=1&pagina=1">Cuentas</a>
                        ...
                        <div class="col-md-2">
                              <li class="nav-item active"><a
                                    class="nav-link"
                                    href="IndexAdmin.jsp">Salir <span
                                          class="sr-only">(current)</span>
                              </a></li>
                        </div>
                        <div class="col-md-2">
                        ...
                        <form action="ServletUsuario" method="get">
                              ...
                              <div
                                    ...
                                    <input type="hidden" name="TXTsexo"
                                          value="<%=usuario.getPersona().getSexo()%>" />
                                    <input type="hidden" name="TXTcuil"
                                          value="<%=usuario.getPersona().getCuil()%>" />
                                    <input type="hidden" name="TXTdia"
                                          value="<%=request.getAttribute("dia")%>" />
                                    <input type="hidden" name="TXTmes"
                                          value="<%=request.getAttribute("mes")%>" />
                                    <input type="hidden" name="TXTanio"
                                          value="<%=request.getAttribute("anio")%>" />
                                    <input type="submit"
                                          name="BtnSiguiente2"
                                          value="Siguiente">
                              </div>
