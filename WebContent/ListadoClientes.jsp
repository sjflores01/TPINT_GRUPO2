			...
			<div class="col-md-10" style="">
				<form action="ServletUsuario" method="get">
					<label for="">Buscar</label> <input type="text"
						...
						aria-describedby="emailHelp" placeholder="apellido o dni">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn btn-primary"
								href="ServletCuenta?nuevaCuenta=<%=user.getId()%>">Nueva
									Cuenta</a></td>
							...
							<td><a class="btn btn-warning"
								href="ServletUsuario?cargaEliminar=<%=user.getId()%>">Eliminar</a></td>
